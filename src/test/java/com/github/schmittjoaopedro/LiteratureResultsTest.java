...
public class LiteratureResultsTest {
    ...
    static {
        pdptw100Directory = Paths.get(StaticNvMinimizerTest.class.getClassLoader().getResource("pdptw/100-tasks").getFile().substring(1)).toString();
    }
    ...
    public void lc1Test() throws Exception {
        ...
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(1035.3499342457624);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(9);
        int idx = 0;
    ...
    public void lc2Test() throws Exception {
        ...
        solver.run();
        Solution solutionBest = solver.getSolutionBest();
        AssertionsForClassTypes.assertThat(solutionBest.feasible).isTrue();
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(588.8759626534237);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(3);
        int idx = 0;
    ...
    public void lr1Test() throws Exception {
        ...
        Solution solutionBest = solver.getSolutionBest();
        AssertionsForClassTypes.assertThat(solutionBest.feasible).isTrue();
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(1003.766997800698);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(9);
        int idx = 0;
    ...
    public void lr2Test() throws Exception {
        ...
        Solution solutionBest = solver.getSolutionBest();
        AssertionsForClassTypes.assertThat(solutionBest.feasible).isTrue();
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(930.5857489156436);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(3);
        int idx = 0;
    ...
    public void lrc1Test() throws Exception {
        ...
        Solution solutionBest = solver.getSolutionBest();
        AssertionsForClassTypes.assertThat(solutionBest.feasible).isTrue();
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(1637.6243913700941);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(13);
        int idx = 0;
    ...
    public void lrc2Test() throws Exception {
        ...
        Solution solutionBest = solver.getSolutionBest();
        AssertionsForClassTypes.assertThat(solutionBest.feasible).isTrue();
        AssertionsForClassTypes.assertThat(solutionBest.totalCost).isEqualTo(1089.0676879447258);
        AssertionsForClassTypes.assertThat(solutionBest.tours.size()).isEqualTo(3);
        int idx = 0;
